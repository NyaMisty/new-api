...
import LogContentModal from './modals/LogContentModal';
...
const LogsPage = () => {
  ...
  return (
    <>
      ...
      <LogContentModal
        visible={logsData.showLogContentModal}
        onClose={() => logsData.setShowLogContentModal(false)}
        logId={logsData.selectedLogId}
        t={logsData.t}
      />
